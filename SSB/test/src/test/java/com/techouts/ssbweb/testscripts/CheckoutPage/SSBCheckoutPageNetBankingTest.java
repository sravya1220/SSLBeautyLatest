...
public class SSBCheckoutPageNetBankingTest extends AbstractTest {
		...
		public void verifyCreditcardpayatcheckout() {
			try {
				 ...
				 * mobilelogin.getMobileno()); ssbLoginActions.openNewTab(TEST_CASE_NAME);
				 * getSslBackofficeUrl(); User backofficelogin =
				 * Objects.requireNonNull(CredentialProvider.getUser("E010"),
			...
			//	getSslDecryptUrl();
				...
				ssbcheckoutpagenetbanking.NavigatetoCartPage(TEST_CASE_NAME);
				...
				ssbcheckoutpagenetbanking.removeProduct(TEST_CASE_NAME);
