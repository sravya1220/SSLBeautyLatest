...
public class SSBCheckoutPageUPIAction extends GlobalExceptionHandler {
	...
	public void NavigatetoCartPage(String testCaseName) {
		try {
			...
			WebElementOperationsWeb.captureScreenShotOnPass(driver, testCaseName, "NavigatetoCartPage");
		} catch (Exception e) {
	...
	public void ClickingonProceedNow(String testCaseName) {
		try {
			...
			WebElementOperationsWeb.park(5);
			WebElementOperationsWeb.captureScreenShotOnPass(driver, testCaseName, "ClickingonProceedNow");
		} catch (Exception e) {
			handleOnException("All Fields Displayed not able found", e);
		}
	}
	...
	public void removeProduct(String testCaseName) {
		try {
			ssbcheckoutupipay.cartClick();
			WebElementOperationsWeb.park(3);

			ssbcheckoutupipay.productRemove();
			ssbcheckoutupipay.productRemoveBtn();
